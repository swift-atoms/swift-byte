...
Hex rendering is NOT part of `Byte`. Use a dedicated encoder package — `swift-binary-base` (`Binary.Base.16`, for Base16/Base32/Base64/Base85) or [`swift-rfc-4648`](https://github.com/swift-ietf/swift-rfc-4648) (`RFC_4648.Base16`, the canonical RFC 4648 encoder).
...
The package depends only on `swift-carrier`.
